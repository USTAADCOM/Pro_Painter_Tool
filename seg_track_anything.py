...
def video_type_input_tracking(SegTracker, input_video, io_args, video_name, frame_num=0):
    ...
    imageio.mimsave(io_args['output_gif'], masked_pred_list)
    ...
    torch.cuda.empty_cache()
    gc.collect()
    return f'results/{video_name}_masked_frames/inpaint_out.mp4',io_args['output_video'], io_args['output_mask_dir'], io_args['output_masked_frame_dir'], f"{io_args['tracking_result_dir']}/{video_name}_pred_mask.zip"
